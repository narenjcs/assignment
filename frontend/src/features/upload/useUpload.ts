...
export interface UseUploadOptions {
  ...
  /** Fired for every SSE frame, so a parent can feed the flow diagram a live event list while a
   * sync upload streams (UI-PLAN §1: "plus live SSE events in sync mode"). */
